  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <p className="text-primary font-medium tracking-wide uppercase">Hello, I&apos;m</p>
              <h1 className="text-5xl md:text-7xl font-bold">
                <span className="gradient-text">Rutik Kolhapure</span>
              </h1>
              <div className="h-16">
                <TypeAnimation
                  sequence={[
            ...
            <div className="flex gap-6 pt-4">
              <a href="https://linkedin.com/in/rutik-kolhapure" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-primary transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="https://github.com/rutik-kolhapure" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-primary transition-colors">
          ...
          <div className="hidden lg:flex justify-center">
            <div className="relative w-[340px] h-[340px]">
              ...
              <div className="absolute bottom-6 -right-8 bg-white rounded-xl shadow-lg shadow-slate-300/50 border border-slate-100 px-4 py-3 flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-secondary/10 flex items-center justify-center flex-shrink-0">
                  <FiTrendingUp className="text-secondary" size={18} />
                </div>
                <div>
                  <div className="font-bold text-slate-900 text-sm leading-tight">8+ Products</div>
                  <div className="text-slate-500 text-xs leading-tight">Delivered</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#experience" className="text-slate-500 hover:text-primary">
